        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Library ManageMent</span>
            </a>
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="{{ route('admin.author.index') }}" class="menu-link">
                      <div data-i18n="Account">Author Section</div>
                    </a>
                  </li>
                ...
                <ul class="menu-sub">
                  ...
                  <li class="menu-item">
                    <a href="{{ route('admin.subcategory.index') }}" class="menu-link">
                      <div data-i18n="Account">SubCategory List</div>
                    </a>
                  </li>
                </ul>
              </li>
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="{{ route('admin.post.create') }}" class="menu-link">
                      <div data-i18n="Account">Add new books</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{ route('admin.post.index') }}" class="menu-link">
                      <div data-i18n="Account">Book list</div>
                    </a>
                  </li>
